...
If we use this feature, in combination with [database constraints](/migrations/create-table#constraints) and validations, we can guarantee a **strong** level of **data integrity** for our projects.

**You can set your own set of attributes via [custom schema](/entities/custom-schema).**
